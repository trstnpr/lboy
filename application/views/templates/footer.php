					...
					<div class="row">
						...
						<div class="col-md-6">
							<ul class="nav-menu">
								...
								<li><a href="mailto:<?php echo the_config('admin_email'); ?>"><?php echo the_config('admin_email'); ?></a></li>

								<li><a href="tel:<?php echo the_config('phone_number'); ?>"><?php echo the_config('phone_number'); ?></a></li>
