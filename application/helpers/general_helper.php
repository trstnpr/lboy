<?php
    ...
    function recent_blog($limit) {
        $CI =& get_instance();

        $model = $CI->Page_model->get_published_post($limit);
    ...
    function major_area() {
        ...
        $areas = $CI->City_model->get_popular_city();
    ...
    function secure_url($url) { // SSL API EXTERNAL RESOURCES
